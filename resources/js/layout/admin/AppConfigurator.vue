...
function updateColors(type, color) {
    if (type === "primary") {
        ...
        localStorage.setItem("primary", JSON.stringify(color));
    } else if (type === "surface") {
        setSurface(color.name);
        localStorage.setItem("surface", JSON.stringify(color));
    }
...
onBeforeMount(() => {
    ...
    if (localStorage.getItem("preset")) {
        preset.value = JSON.parse(localStorage.getItem("preset"));
        onPresetChange();
    }
...
onMounted(() => {
    if (localStorage.getItem("primary")) {
        updateColors("primary", JSON.parse(localStorage.getItem("primary")));
    }

    if (localStorage.getItem("surface")) {
        updateColors("surface", JSON.parse(localStorage.getItem("surface")));
    }
});
</script>
