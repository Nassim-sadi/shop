...
namespace Nebed\UserAgent\Facades {
     ...
     */        class UserAgent {
         ...
         *
         * @static 
         */        public static function parse($userAgent, $jsParseBits = [])
        {
                        /** @var \UAParser\Parser $instance */
                        return $instance->parse($userAgent, $jsParseBits);
        }
                    /**
        ...
        {
                        return \UAParser\Parser::create($file);
        }
            }
    }
